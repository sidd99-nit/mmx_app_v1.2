...
def upload_file():
    ...
    profile_sales = ProfileReport(df_sales.sample(frac=0.60), title="Sales Profiling Report", explorative=False , dark_mode=True , minimal=True , correlations=None)
    ...
    profile_media = ProfileReport(df_media.sample(frac=0.50), title="Media Profiling Report", explorative=False , dark_mode=True , correlations=None )
